...
router.get('/', async (req, res) => {                      //Para leer la informacion de todos los productos tenemos que crear un lugar a donde IR a leerlos
    try{
...
router.post('/', async (req, res) => {                      //Metodo para crear productos
    try{
...
router.get('/:id', async (req, res) => {                      //Metodo para encontrar por id un producto especifico
    try{
